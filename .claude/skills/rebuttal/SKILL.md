...
- **REVIEWER_MODEL = `gpt-5.5`** — Used via Codex CLI for internal stress-testing.
...
Save full response to `rebuttal/CLI_STRESS_TEST.md`. If hard safety blocker → revise before finalizing.
...
6. Use Codex CLI reply for continuity if useful
...
- **Preserve raw records.** Reviews and CLI outputs stored verbatim.
